...
register(
    'CryptoPortfolio-v0',
    entry_point='environments.crypto_env:CryptoPortfolioEnv',
    kwargs={'data_dir': 'data/1h', 'top_k': 4, 'fee_rate': 0.001},
    # max_episode_steps handled internally or by wrapper? 
    # Usually safer to set it high.
